...
protocol PinboardLayoutDelegate: AnyObject {
...
class PinboardCustomLayout: UICollectionViewLayout {
    ...
    private var imgCache: [UICollectionViewLayoutAttributes] = []
    ...
    override func prepare() {
      ...
      guard imgCache.isEmpty, let collectionView = collectionView else {
          return
      }
    ...
    override func layoutAttributesForElements(in rect: CGRect)
      ...
      // Loop through the cache and look for items
      for attributes in imgCache {
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath)
        -> UICollectionViewLayoutAttributes? {
      return imgCache[indexPath.item]
    }
}
